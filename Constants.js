...
export const PRIORITY_LEVEL_STEP = 3000;
...
export const BUILD_PRIORITY = {
  STRUCTURE_ROAD : 1 * PRIORITY_LEVEL_STEP,
  STRUCTURE_CONTAINER : 1 * PRIORITY_LEVEL_STEP,
  STRUCTURE_STORAGE :   1 * PRIORITY_LEVEL_STEP,
  STRUCTURE_SPAWN :   1.5 * PRIORITY_LEVEL_STEP,
  STRUCTURE_EXTENSION :   1.5 * PRIORITY_LEVEL_STEP,
  STRUCTURE_TOWER :   1 * PRIORITY_LEVEL_STEP,
  STRUCTURE_WALL :      0 * PRIORITY_LEVEL_STEP,
  STRUCTURE_RAMPART :   1 * PRIORITY_LEVEL_STEP,
}
...
export const NOT_APPLICAPLE = 1000;
